...
var createTaskEl = function (taskDataObj) {
  ...
  // add id along with value to taskDataObj
...
var createTaskActions = function (taskId) {
  ...
  // for loop to add select option children
  ...
  // end for loop to add select option children
...
var loadTasks = function () {
  ...
  // check to see if tasks is null if it is set it back to an empty array
  if (tasks === null) {
    tasks = [];
    return false;
  }
  ...
  // create DOM elements from tasks
